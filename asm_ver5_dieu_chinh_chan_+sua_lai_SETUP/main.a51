...
wr_ bit p2.5	;allow converting 
intr_ bit p2.4	;converting succeed
rd_ bit p2.6	;allow communicating
cs_ bit p3.3	
...
MOV delay_count, #0
mov a, p2  		//		, lay gia tri bit p2.7 roi luu vao a
anl a, #80h		// a = a & 1000 0000  //lay gia tri cua cai led warning
cjne a,#80h, TURN_ON		//neu bam nut button_ok thi thoat khoi cai SETUP
clr spk
lcall OFF_WARNING
...
clr c
setb led_orange
mov button_inc, p3  		//		, lay gia tri bit p2.7 roi luu vao button_inc
anl button_inc, #80h		// button_inc = button_inc & 1000 0000
mov a, button_inc
mov b, inc_set
...
mov button_ok, p3 		//		, lay gia tri bit p2.6 roi luu vao button_ok
anl button_ok, #40h		// button_inc = button_ok & 0100 0000
mov a, button_ok
mov b, ok_set
...
NOT_EQ_OK_SET:
mov a, button_ok
cjne a, #40h, BAM_NUT_OK				//xem co dang bam hay khong
NEXT_2:
...
SHOW:
	...
	setb donvi
	lcall DELAY_1
	anl p2,#0f0h			//p2 = p2 & 11110000; tat 4 bit dau di
...
WARNING:
	...
	;lcall OFF_WARNING									<<<<<<<<<<<<<--
	;lcall DELAY_2
	mov button_ok, p3  		//		, lay gia tri bit p3.6 roi luu vao button_ok, h nut nay la nut reset
	anl button_ok, #40h		// button_ok = button_ok & 0100 0000
	mov a, button_ok
	;mov b, ok_set
	cjne a,#40h, RESET		//neu bam nut button_ok thi thoat khoi cai SETUP
	jmp WARNING_NEXT
