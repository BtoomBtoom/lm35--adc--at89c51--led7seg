...
mov num_set, #87		//luu so duoc cai dat// cho so ban dau bay gio là 87
mov p2, #000h		//port2 là internal pull up
mov p1,#000h		//port1 cung là internal pull up
mov a, #0h        
...
mov a, button_ok
;mov b, ok_set
cjne a,#0, MAIN		//neu bam nut button_ok thi thoat khoi cai SETUP
sjmp SETUP
